    ...
    return (
        <Show when={store.selectedScene} fallback={<div>Loading...</div>}>
            ...
            <div className="title">
                ...
                <svg on:click={playScene} xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-play-circle-fill pointer" viewBox="0 0 16 16">
